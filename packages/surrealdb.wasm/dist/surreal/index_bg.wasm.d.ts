...
export function surrealwasmengine_connect(
	a: number,
	b: number,
	c: number,
): number;
export function surrealwasmengine_export(a: number, b: number): number;
export function surrealwasmengine_version(a: number): void;
export function ring_core_0_17_8_bn_mul_mont(
	a: number,
	b: number,
	c: number,
	d: number,
...
export function intounderlyingbytesource_autoAllocateChunkSize(
	a: number,
): number;
...
export function __wbindgen_export_3(
	a: number,
	b: number,
	c: number,
	d: number,
...
export function __wbindgen_export_8(
	a: number,
	b: number,
	c: number,
	d: number,
